...
class __TwigTemplate_d10b809203d5cdf71567f08d33ef81f58560e94040a44cb412e007a05af91a7a extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 38
        if ((((0 === twig_compare(twig_length_filter($this->env, ($context["host"] ?? null)), 0)) || (0 === twig_compare(twig_length_filter($this->env, ($context["user"] ?? null)), 0))) || twig_get_attribute($this->env, $this->source, ($context["link"] ?? null), "connect_error", [], "any", false, false, false, 38))) {
            // line 39
            echo "
   ";
            // line 40
         ...
         <form action='install.php' method='post'>
            <div class=\"mb-3\">
               <h3>
                  ";
                // line 79
                echo twig_escape_filter($this->env, (((0 === twig_compare(($context["update"] ?? null), "no"))) ? (__("Please select a database:")) : (__("Please select a database to update:"))), "html", null, true);
                echo "
               </h3>
               <div class=\"form-selectgroup form-selectgroup-boxes d-flex flex-column\">
                  ";
                // line 82
                if ((0 === twig_compare(($context["update"] ?? null), "no"))) {
                    // line 83
...
{% else %}
   ...
   {% endif %}
{% endif %}
", "install/step3.html.twig", "C:\\desarrollo\\xampp\\htdocs\\glpi\\templates\\install\\step3.html.twig");
    }
}
